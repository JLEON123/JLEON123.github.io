...
```{r, include=TRUE}
ggplot(data = "./data/S_Stem_project/Abiotic_stress_results.csv")+ geom_mosaic(aes(x = product(Alive, Heat)), fill=c("#000000", "#275d38", "#000000", "#275d38")) + labs(x = "Heat", y = "Alive")+
theme_minimal
```
...
```{r, programtable}
df <- read.csv("./data/S_Stem_project/program_metadata/00_versions.csv")
