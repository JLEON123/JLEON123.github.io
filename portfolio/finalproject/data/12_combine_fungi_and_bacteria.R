...
# load data objects
fung_2019 <- readRDS("./data/Lee_2019_noncontam_ps_object.RDS")
fung_2020 <- readRDS("./data/Lee_2020_noncontam_ps_object.RDS")
bact <- readRDS("./data/full_cleaned_ps_object_w_tree.RDS")
...
# save full ps object
saveRDS(full2,"./data/bact_and_fungi_clean_ps_object")
