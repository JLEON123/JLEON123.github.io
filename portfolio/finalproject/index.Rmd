...
# hrbrthemes::import_roboto_condensed() # Arial Narrow or Roboto condensed fonts are needed for this library
...
Library <- c("R", "tidyverse", "dada2", "purrr", "Biostrings", "ShortRead", "ggmap", 'kableExtra', 'hrbrthemes')
Version <- c("4.1.1", '1.3.2', '1.20.0', '0.3.5', '2.60.2', '1.50.0', '3.0.1', '1.3.4', '0.8.0')
...
To begin, I want to see if I can find any trends in the data. I'll start by comparing the abundance of bacteria to fungi in the samples based on three predicting variables.  
  ...
  **3. The location the sample was collected from (See maps above) **
```{r}
...
```
![A nice image.](./media/Abundance2.jpg){width=110%,height=110%}
```{r, echo=FALSE, out.width="150%", out.height="150%"}
# Saving plot to format in Canva #
