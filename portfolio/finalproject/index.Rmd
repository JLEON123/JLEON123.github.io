...
tidy(species_mod)
```
Microbe as a function of plant structure
```{r}
...
tidy(structure_mod)
```
Microbe as a function of Location and Country
```{r}
...
tidy(location_mod)
```
Microbe as a function of lat/lon
```{r}
